-- AlterTable
ALTER TABLE "Roster" ADD COLUMN "areaBottom" REAL;
ALTER TABLE "Roster" ADD COLUMN "areaLeft" REAL;
ALTER TABLE "Roster" ADD COLUMN "areaRight" REAL;
ALTER TABLE "Roster" ADD COLUMN "areaTop" REAL;
ALTER TABLE "Roster" ADD COLUMN "columnCount" INTEGER;
ALTER TABLE "Roster" ADD COLUMN "columnsPerBand" INTEGER;
ALTER TABLE "Roster" ADD COLUMN "dayColumnFraction" REAL;
