...
3. Se una cella è stata corretta a **penna**, coperta con il correttore e riscritta, o comunque modificata a mano, metti "handCorrected": true. È l informazione più preziosa che puoi darmi: quelle celle verranno rilette da una persona. **Non è una correzione** il colore: sul foglio intere righe (per esempio le domeniche) e singole celle sono passate con l **evidenziatore** giallo o arancione, e alcune celle hanno un fondo grigio stampato. Il colore di fondo non cambia il codice: per quelle celle metti "handCorrected": false, a meno che sopra non ci sia **anche** una scrittura a mano o del correttore. Una cella marcata senza motivo costa una rilettura a una persona, e troppe riletture inutili tolgono peso a quelle vere.
